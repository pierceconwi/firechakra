...
const Auth = () => {
    ...
    return (
        ...
        <Box display="flex" alignItems="center" justifyContent="space-between">
            ...
            <Box>
                <Button _hover={{ bg: 'red.300' }} variant="ghost" id="home" size={['sm', 'sm', 'md', 'md', 'md']}>
                    <Link href="/" fontSize={['0.8em', '1em', '1.2em', '1.4em', '1.6em']}>Home</Link>
                </Button>
            </Box>
            <Box>
                <Button _hover={{ bg: 'red.300' }} variant="ghost" id="task" size={['sm', 'sm', 'md', 'md', 'md']}>
                    <Link href="/add-todo" fontSize={['0.8em', '1em', '1.2em', '1.4em', '1.6em']}>Task</Link>
                </Button>
            </Box>
            <Box>
                <Button _hover={{ bg: 'red.300' }} variant="ghost" id="event" size={['sm', 'sm', 'md', 'md', 'md']}>
                    <Link href="/add-event" fontSize={['0.8em', '1em', '1.2em', '1.4em', '1.6em']}>Event</Link>
                </Button>
            </Box>
            <Box>
                <Button _hover={{ bg: 'red.300' }} variant="ghost" id="contact" size={['sm', 'sm', 'md', 'md', 'md']}>
            ...
            <Box>
                {isLoggedIn && (
                    <>
                            <Button _hover={{ bg: 'red.300' }} variant="ghost" mr="5%" size={['sm', 'sm', 'md', 'md', 'md']}>
